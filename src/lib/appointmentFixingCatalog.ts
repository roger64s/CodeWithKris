...
export type AppointmentCatalogEntry = {
  ...
  voiceQuality: "Partial (not clear)" | "Unintelligible";
};

export type AppointmentBaseline = {
  languages: AppointmentLanguage[];
...
export const APPOINTMENT_FIXING_BASELINES = {
  Josy: { languages: ["English", "Cantonese"] as AppointmentLanguage[], senderAccuracy: 0.78, senderLagMs: 125, receiverAccuracy: 0.85, receiverLagMs: 90, voiceQuality: "Partial" },
  Sri: { languages: ["Tamil"] as AppointmentLanguage[], senderAccuracy: 0.45, senderLagMs: 250, receiverAccuracy: 0.79, receiverLagMs: 135, voiceQuality: "Not recognizable" },
